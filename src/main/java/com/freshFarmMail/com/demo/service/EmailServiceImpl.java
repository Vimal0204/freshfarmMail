...
//        }
                ...
                @Override
                public boolean sendEmailWelcome(EmailMessageWelcome emailMessageWelcome) {
        ...
        @Override
        public boolean sendEmailCustomerOrderConfirmed(EmailCustomerOrderConfirmed emailMessage) {
        ...
        @Override
        public boolean sendCustomerOrderCancel(EmailCustomerCancelOrder emailMessage){
                String subject=emailMessage.getSubject();
                String to=emailMessage.getTo();
        ...
        @Override
        public boolean sendFarmerOrderReceived(EmailFarmerOrderReceived emailMessage) {
                String subject=emailMessage.getSubject();
                String to=emailMessage.getTo();
